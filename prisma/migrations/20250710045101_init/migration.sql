...
-- CreateEnum
CREATE TYPE "CheckInStatus" AS ENUM ('ON_TRACK', 'MILESTONE', 'BLOCKED');
...
-- CreateIndex
CREATE UNIQUE INDEX "Kudo_userId_checkInId_key" ON "Kudo"("userId", "checkInId");
...
-- AddForeignKey
ALTER TABLE "Pact" ADD CONSTRAINT "Pact_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Kudo" ADD CONSTRAINT "Kudo_checkInId_fkey" FOREIGN KEY ("checkInId") REFERENCES "CheckIn"("id") ON DELETE CASCADE ON UPDATE CASCADE;
